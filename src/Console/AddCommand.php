...
class AddCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'sage-sail:add
     ...
     * @var string
     */
    protected $description = 'Add a service to an existing Sage Sail installation';
    ...
    public function handle()
    {
        ...
        $this->output->writeln('');
        $this->components->info('Additional Sage Sail services installed successfully.');
    }
}
